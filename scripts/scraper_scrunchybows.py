#!/usr/bin/env python3
"""
ScrunchyBowsIndia.com Product Scraper
Extracts products, images, and pricing data from ScrunchyBowsIndia.com
"""
...
class ScrunchyBowsScraper:
    def __init__(self, base_dir="c:/Users/venka/Downloads/Bangles/scraped-data"):
        self.base_url = "https://scrunchybowsindia.com"
        self.base_dir = Path(base_dir)
        self.site_dir = self.base_dir / "scrunchybows"
    ...
    def scrape_all_collections(self):
        ...
        collections = {
            'Beginners Kit': '/collections/beginners-kit',
            'Round Bangles': '/collections/round-bangles',
            'Flat Bangles': '/collections/flat-bangles',
            'Kids Bangles': '/collections/kids-bangles',
            'Silk Thread': '/collections/silk-thread',
            'Charms': '/collections/charms',
            'AD Stone Charms': '/collections/ad-stone-charms',
            'Seed Beads': '/collections/beads',
            'Glass Kundhans': '/collections/glass-white',
            'Ceramic Pearl': '/collections/ceramic-pearl',
            'Clip Stones': '/collections/4mm-clip-stones',
            'Hair Accessories': '/collections/hair-clips',
            'Saree Pins': '/collections/saree-pins',
            'Zardosi': '/collections/zardosi',
            'Tube Beads': '/collections/tube-beads',
            'Jasmine Buds': '/collections/jasmine-buds',
            'MDF': '/collections/mdf',
            'Sequins': '/collections/sequins',
            'Packing Covers': '/collections/bangle-packing-covers-10x10-cms'
        }
    ...
    def run(self):
        ...
        print("Starting ScrunchyBowsIndia.com scraper...")
