...
export const metadata = {
  ...
  title: { default: 'Silk Thread Bangle Materials Online | Bangle by Choice', template: '%s | Bangle by Choice' },
  description: 'Buy premium silk thread bangle-making materials, Kundan stones, bangle bases, charms, adhesives and tools online. Dispatch within 24 hours across India.',
  ...
  publisher: siteName,
  category: 'shopping',
  keywords: ['silk thread bangle making materials', 'bangle making materials online India', 'Kundan stones for bangles', 'silk thread for bangles', 'bangle bases online', 'bangle making tools'],
  alternates: { canonical: '/', languages: { 'en-IN': '/' } },
  openGraph: { title: 'Silk Thread Bangle-Making Materials | Bangle by Choice', description: 'Premium materials for silk-thread bangle makers, delivered across India.', url: '/', siteName, images: [ogImage(defaultOgImage, 'Silk thread bangle-making materials from Bangle by Choice')], locale: 'en_IN', type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Silk Thread Bangle Materials | Bangle by Choice', description: 'Shop thread, Kundan stones, bangle bases, charms and tools for handmade bangles.', images: twitterImage([defaultOgImage]) },
