export default function manifest() {
  return {
    ...
    icons: [
      ...
      { src: '/icons/icon-48.png?v=20260812b', sizes: '48x48', type: 'image/png', purpose: 'any' },
      { src: '/icons/icon-96.png?v=20260812b', sizes: '96x96', type: 'image/png', purpose: 'any' },
      { src: '/icons/icon-180.png?v=20260812b', sizes: '180x180', type: 'image/png', purpose: 'any' },
      { src: '/icons/icon-192.png?v=20260812b', sizes: '192x192', type: 'image/png', purpose: 'any maskable' },
      { src: '/icons/icon-512.png?v=20260812b', sizes: '512x512', type: 'image/png', purpose: 'any maskable' },
    ],
