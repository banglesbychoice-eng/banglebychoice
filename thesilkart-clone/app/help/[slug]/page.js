...
const pages = {
  shipping: { eyebrow: 'Delivery', title: 'Shipping across India', description: 'Delivery times, dispatch information and shipping charges for Bangle by Choice orders across India.', sections: [['When will my order be dispatched?', 'Confirmed orders are normally packed and dispatched within 24 hours on business days. Orders placed on Sundays or public holidays begin processing on the next business day.'], ['How long does delivery take?', 'Estimated delivery is 1-3 business days for Andhra Pradesh and Telangana, 3-5 days for Tamil Nadu, Puducherry and Karnataka, and 4-7 days for most other serviceable locations.'], ['How is shipping calculated?', `Delivery starts at ₹${MINIMUM_SHIPPING_FEE} and is calculated at ₹${SHIPPING_RATE_PER_KG} per kg using the packed shipment weight. Each bangle box is counted at approximately 300g per unit for this calculation.`], ['How does free shipping appear in the cart?', `For eligible orders from ₹${FREE_SHIPPING_MIN}, the cart shows the calculated delivery charge and then deducts the free-shipping benefit. Bangle-box delivery remains payable by weight and is not included in that deduction.`], ['Which courier will deliver?', 'The courier is selected according to PIN-code serviceability, parcel weight and estimated delivery time. Tracking details are shared after pickup.'], ['Is payment required before dispatch?', 'Yes. Orders are prepaid and can be completed through direct UPI or the secure online payment option shown at checkout.'], ['Where can I track my order?', 'Open the Order Tracking page and enter the order number with the 10-digit mobile number used at checkout.']] },
