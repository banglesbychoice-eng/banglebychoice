...
const pages = {
  ...
  contact: { eyebrow: 'We are here', title: 'Talk to Bangle by Choice', description: 'Contact Bangle by Choice in Hyderabad for product and order support.', sections: [['WhatsApp', '+91 95536 55562'], ['Official Instagram', '@banglebychoice'], ['Location', 'Hyderabad, India'], ['Support hours', 'Monday to Saturday, 10:00 AM to 7:00 PM IST.']] },
  about: { eyebrow: 'Our story', title: 'About Bangle by Choice', description: 'Learn about Bangle by Choice, a Hyderabad-based store focused on silk thread bangle-making materials.', sections: [['What we do', 'We curate silk thread, Kundan stones, bangle bases, charms, adhesives and tools for thread bangle makers across India.'], ['Our promise', 'Useful product guidance, careful packing and responsive WhatsApp support are at the heart of every order.'], ['Based in Hyderabad', 'Orders are prepared in Hyderabad and delivered across India.']] },
...
function pageSchema(slug, page) {
  ...
  if (slug === 'contact' || slug === 'order-help') {
    return {
      ...
      mainEntity: { '@type': 'Organization', name: siteName, telephone: '+91 95536 55562', sameAs: ['https://www.instagram.com/banglebychoice/'], contactPoint: { '@type': 'ContactPoint', telephone: '+91 95536 55562', contactType: 'customer support', areaServed: 'IN', availableLanguage: ['English', 'Hindi', 'Telugu'] } },
    };
  }
    ...
    <>
      ...
      <main className={styles.page}>
        ...
        <div className={styles.actions}>
          ...
          {slug === 'contact' ? <a href="https://www.instagram.com/banglebychoice/" target="_blank" rel="me external noopener noreferrer">Follow on Instagram</a> : null}
        </div>
      </main>
    </>
  );
