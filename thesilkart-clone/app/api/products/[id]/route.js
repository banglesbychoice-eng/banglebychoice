...
import { getDefaultBanglePacks, supportsBangleSizes } from '@/lib/pricing';
...
export async function PUT(request, { params }) {
  ...
  if (supportsBangleSizes(nextProduct) && (!Array.isArray(nextProduct.sizes) || !nextProduct.sizes.length)) fields.sizes = getDefaultBanglePacks(nextProduct);
