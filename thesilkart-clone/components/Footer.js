  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.footerTop}>
        <div className={styles.brand}><Link href="/"><span>Bangle</span><b>by Choice</b></Link><p>Silk thread bangle-making materials, Kundan stones, bangle bases, charms and tools for makers across India.</p></div>
